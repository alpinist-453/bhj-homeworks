const arrReveal = Array.from(document.querySelectorAll('.rotator__case'))

function isVisible(arr) {
	let indexActiv = arr.findIndex(el => Array.from(el.classList).includes('rotator__case_active'));
